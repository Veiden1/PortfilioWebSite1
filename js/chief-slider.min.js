...
ChiefSlider.prototype._addEventListener = function() {
    ...
    var t = this._$indicatorList,
        i = this._$itemList;
    if (t.length)
        for (var e = 0, s = i.length; e < s; e++) { i[e].classList.contains(CLASS_ITEM_ACTIVE) ? t[e].classList.add(CLASS_INDICATOR_ACTIVE) : t[e].classList.remove(CLASS_INDICATOR_ACTIVE) }
...
}, ChiefSlider.prototype._moveToNext = function() { this._direction = "next", this._move() }, ChiefSlider.prototype._moveToPrev = function() { this._direction = "prev", this._move() }, ChiefSlider.prototype._moveTo = function(t) {
...
}, ChiefSlider.prototype._autoplay = function(t) { if (this._config.autoplay) return "stop" === t ? (clearInterval(this._intervalId), void(this._intervalId = null)) : void(null === this._intervalId && (this._intervalId = setInterval(function() { this._direction = "next", this._move() }.bind(this), this._config.interval))) }, ChiefSlider.prototype._refresh = function() {
    var t = this._$itemList,
        i = t[0].offsetWidth,
    ...
    if (s !== this._itemsInVisibleArea) {
        ...
        if (this._setActiveClass(), this._updateIndicators(), window.requestAnimationFrame(function() { this._$items.classList.remove(SLIDER_TRANSITION_OFF) }.bind(this)), this._config.loop) {
            var h = t.length - 1,
                _ = 100 * -t.length;
